...
def update_employee(supid, field, new_value):
    try:
        cursor.execute("UPDATE signup SET {}=? WHERE empid=?".format(field), (new_value, supid))
        conn.commit()
        print("<p>signup details updated successfully.</p>")
    except Exception as e:
        print("<p>Error updating signup details: {}</p>".format(str(e)))
...
print("<option value='password'>password</option>")
