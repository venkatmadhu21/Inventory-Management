...
if "action" in form:
    ...
    if action == "Display":
        ...
        cursor.execute("SELECT * FROM itemtable WHERE itemid LIKE ?", ('%' + search_query + '%',))
        suppliers = cursor.fetchall()
...
<div style='text-align: center; padding: 20px;'>
    <form method='post' action=''>
        <label for='search' style='color: #800000; font-weight: bold;'>Search Item by Item ID or Item Name:</label>
...
print("<h1 style='color: #800000; font-size: 24px; font-weight: bold; text-align: left;'>Item Details</h1>")
...
print("<th class='nav__title'>itename</th>")
