...
db_name = "Kmce1.db"  # Change this to your database name
conn = sqlite3.connect(db_name)
cursor = conn.cursor()

# Fetching data from the requirement table
...
<header class='text-gray-600 body-font navbar' style='background-color: #800000;'>
    <div class='container mx-auto relative flex flex-wrap p-3 flex-col md:flex-row items-start' style='margin-top: -40px; padding-top: 20px;padding-bottom: 20px;'>
        <nav class='flex flex-wrap items-start text-base justify-start'>
            <a class='mr-5 hover:text-lightgray text-white' href='index.html' style='font-size:20px;'>HOME</a>
            <a class='mr-5 hover:text-lightgray text-white' href='about.html' style='font-size:20px;'>ABOUT US</a>
             <a class="mr-5 hover:text-lightgray text-white" href="inventory.html" style='font-size:20px;'>GO BACK</a>
            <div class='dropdown'>
...
print("<div class='employee-details' style='text-align: left; padding-top: 35px; color: #800000;'>")  # Add padding between heading and table and change text color
print("<h1 style='color: #800000; font-size: 24px; font-weight: bold; margin-left:20px; '>  Requirement  History :-</h1>")

print("<div style='overflow-x:auto; padding-top: 20px;'>")  # Add padding to the table container
print("<table style='margin: auto; border: 1px solid #800000; width: 75%'>")  # Add border to the table
print("<tr>")
print("<th class='nav__title'>Employee id</th>")
print("<th class='nav__title'>  Item id</th>")
print("<th class='nav__title'>Quantity</th>")
print("<th class='nav__title'> Requirement date</th>")    
print("<th class='nav__title'>Requirement met?</th>")
...
if "employees" in locals():
    ...
    print("<tr><td colspan='14'>No Requirement details found.</td></tr>")
print("</table>")
print("</div>")
print("</div>")
