...
if "action" in form:
    ...
    if action == "Display":
        ...
        cursor.execute("SELECT supid, sname, area || ', ' || locality || ', ' || pincode AS address, emailid, phoneno1, phoneno2, phoneno3,blacklisted FROM suppliers WHERE sname LIKE ?", ('%' + search_query + '%',))
        suppliers = cursor.fetchall()
...
<div style='text-align: center; padding: 20px;'>
    <form method='post' action=''>
        <label for='search' style='color: #800000; font-weight: bold;'>Search Supplier by Name:</label>
...
print("<th class='nav__title'>PhoneNo 1</th>")
print("<th class='nav__title'>PhoneNo 2</th>")
print("<th class='nav__title'>PhoneNo 3</th>")
