...
print("<h1 style='color: #800000; font-size: 27px; font-weight: bold; text-align: center;padding-left:10px;'>  Item History  </h1>")
...
print("<th class='nav__title'>Quantity Bought</th>")
print("<th class='nav__title'>Supplier ID</th>")
print("<th class='nav__title'>Amount</th>")
print("<th class='nav__title'>Mode of Payment</th>")
print("<th class='nav__title'>Receipt Number</th>")
print("<th class='nav__title'>Receipt Date</th>")
print("<th class='nav__title'>Order Date</th>")
print("<th class='nav__title'>Arrival Date</th>")
