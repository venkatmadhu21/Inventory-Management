...
print("<option value='quantity'>quantitybought</option>")
print("<option value='paymentdate'>supid</option>")
print("<option value='paymentdate'>amount</option>")
print("<option value='modeofpayment'>modeofpayment</option>")
print("<option value='receivedbyempid'>receiptnumber</option>")
print("<option value='receivedbyempid'>receiptdate</option>")
print("<option value='receivedbyempid'>orderdate</option>")
print("<option value='receivedbyempid'>arrivaldate</option>")
