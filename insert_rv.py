...
# Add some spacing between navbar and "RV Details" heading
print("<div style='margin-top: 20px;'></div>")

# Function to insert RV details
def insert_rv(rvnumber, itemid, quantitybought, supid, amount, modeofpayment, receiptnumber, receiptdate, orderdate, arrivaldate):
    try:
        cursor.execute("INSERT INTO rvtable (rvnumber, itemid, quantitybought, supid, amount, modeofpayment, receiptnumber, receiptdate, orderdate, arrivaldate) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",
                       (rvnumber, itemid, quantitybought, supid, amount, modeofpayment, receiptnumber, receiptdate, orderdate, arrivaldate))
        conn.commit()
        print("<p style='color: green;'>Record inserted successfully!</p>")
    except sqlite3.Error as e:
        print(f"<p style='color: red;'>Error inserting record: {e}</p>")

# Form to input RV details for insertion
...
print("<label for='rvnumber' style='color: #800000; font-weight: bold;'>RV Number:</label>")
print("<input type='text' id='rvnumber' name='rvnumber' style='margin-left: 10px; padding: 5px; border: 1px solid #800000;'><br>")
...
print("<label for='quantitybought' style='color: #800000; font-weight: bold;'>Quantity Bought:</label>")
print("<input type='text' id='quantitybought' name='quantitybought' style='margin-left: 10px; padding: 5px; border: 1px solid #800000;'><br>")
...
print("<label for='amount' style='color: #800000; font-weight: bold;'>Amount:</label>")
print("<input type='text' id='amount' name='amount' style='margin-left: 10px; padding: 5px; border: 1px solid #800000;'><br>")
print("<label for='modeofpayment' style='color: #800000; font-weight: bold;'>Mode of Payment:</label>")
print("<input type='text' id='modeofpayment' name='modeofpayment' style='margin-left: 10px; padding: 5px; border: 1px solid #800000;'><br>")
print("<label for='receiptnumber' style='color: #800000; font-weight: bold;'>Receipt Number:</label>")
print("<input type='text' id='receiptnumber' name='receiptnumber' style='margin-left: 10px; padding: 5px; border: 1px solid #800000;'><br>")
print("<label for='receiptdate' style='color: #800000; font-weight: bold;'>Receipt Date:</label>")
print("<input type='text' id='receiptdate' name='receiptdate' style='margin-left: 10px; padding: 5px; border: 1px solid #800000;'><br>")
print("<label for='orderdate' style='color: #800000; font-weight: bold;'>Order Date:</label>")
print("<input type='text' id='orderdate' name='orderdate' style='margin-left: 10px; padding: 5px; border: 1px solid #800000;'><br>")
print("<label for='arrivaldate' style='color: #800000; font-weight: bold;'>Arrival Date:</label>")
print("<input type='text' id='arrivaldate' name='arrivaldate' style='margin-left: 10px; padding: 5px; border: 1px solid #800000;'><br>")

print("<button type='submit' name='action' value='Insert' style='padding: 5px 10px; background-color: #800000; color: white; border: none; cursor: pointer; margin-top: 10px;'>Insert</button>")
print("</form>")
print("</div>")

# Process form submission
if "action" in form and form["action"].value == "Insert":
    if all(key in form for key in ['rvnumber', 'itemid', 'quantitybought', 'supid', 'amount', 'modeofpayment', 'receiptnumber', 'receiptdate', 'orderdate', 'arrivaldate']):
        rvnumber = form["rvnumber"].value
        itemid = form["itemid"].value
        quantitybought = form["quantitybought"].value
        supid = form["supid"].value
        amount = form["amount"].value
        modeofpayment = form["modeofpayment"].value
        receiptnumber = form["receiptnumber"].value
        receiptdate = form["receiptdate"].value
        orderdate = form["orderdate"].value
        arrivaldate = form["arrivaldate"].value
        insert_rv(rvnumber, itemid, quantitybought, supid, amount, modeofpayment, receiptnumber, receiptdate, orderdate, arrivaldate)
    else:
        print("<p style='color: red;'>All fields are required for insertion.</p>")
