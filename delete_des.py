...
def delete_supplier(sid):
    try:
        cursor.execute("DELETE FROM designation WHERE desid=?", (sid,))
        conn.commit()
        print("<p>Designation details deleted successfully.</p>")
...
print("<label for='sid' style='color: #800000; font-weight: bold;'>Enter depid ID to Delete:</label>")
