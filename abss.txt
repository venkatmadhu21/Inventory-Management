...
def insert_employee(empid, fname, mname, lname, desiationid, qualification, joiningdate, phoneno, dateofleaving, depid, emailid, area, locality, unitno, Pincode):
    try:
        cursor.execute("INSERT INTO employee (empid, fname, mname, lname, desiationid, qualification, joiningdate, phoneno, dateofleaving, depid, emailid, area, locality, unitno, Pincode) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",
                       (empid, fname, mname, lname, desiationid, qualification, joiningdate, phoneno, dateofleaving, depid, emailid, area, locality, unitno, Pincode))
        conn.commit()
        print("<p>New employee details inserted successfully.</p>")
    except Exception as e:
        print("<p>Error inserting new employee details: {}</p>".format(str(e)))

# Form to input new employee details for insertion
...
print("<input type='text' id='empid' name='empid' style='margin-left: 10px; padding: 5px; border: 1px solid #800000;' required>")
print("<br>")
print("<label for='fname' style='color: #800000; font-weight: bold;'>First Name:</label>")
print("<input type='text' id='fname' name='fname' style='margin-left: 10px; padding: 5px; border: 1px solid #800000;' required>")
print("<br>")
print("<label for='mname' style='color: #800000; font-weight: bold;'>Middle Name:</label>")
print("<input type='text' id='mname' name='mname' style='margin-left: 10px; padding: 5px; border: 1px solid #800000;'>")
print("<br>")
print("<label for='lname' style='color: #800000; font-weight: bold;'>Last Name:</label>")
print("<input type='text' id='lname' name='lname' style='margin-left: 10px; padding: 5px; border: 1px solid #800000;'>")
print("<br>")
print("<label for='desiationid' style='color: #800000; font-weight: bold;'>Designation ID:</label>")
print("<input type='text' id='desiationid' name='desiationid' style='margin-left: 10px; padding: 5px; border: 1px solid #800000;'>")
print("<br>")
print("<label for='qualification' style='color: #800000; font-weight: bold;'>Qualification:</label>")
print("<input type='text' id='qualification' name='qualification' style='margin-left: 10px; padding: 5px; border: 1px solid #800000;'>")
print("<br>")
print("<label for='joiningdate' style='color: #800000; font-weight: bold;'>Joining Date:</label>")
print("<input type='text' id='joiningdate' name='joiningdate' style='margin-left: 10px; padding: 5px; border: 1px solid #800000;'>")
print("<br>")
print("<label for='phoneno' style='color: #800000; font-weight: bold;'>Phone Number:</label>")
print("<input type='text' id='phoneno' name='phoneno' style='margin-left: 10px; padding: 5px; border: 1px solid #800000;'>")
print("<br>")
print("<label for='dateofleaving' style='color: #800000; font-weight: bold;'>Date of Leaving:</label>")
print("<input type='text' id='dateofleaving' name='dateofleaving' style='margin-left: 10px; padding: 5px; border: 1px solid #800000;'>")
print("<br>")
print("<label for='depid' style='color: #800000; font-weight: bold;'>Department ID:</label>")
print("<input type='text' id='depid' name='depid' style='margin-left: 10px; padding: 5px; border: 1px solid #800000;'>")
print("<br>")
print("<label for='emailid' style='color: #800000; font-weight: bold;'>Email ID:</label>")
print("<input type='text' id='emailid' name='emailid' style='margin-left: 10px; padding: 5px; border: 1px solid #800000;'>")
print("<br>")
print("<label for='area' style='color: #800000; font-weight: bold;'>Area:</label>")
print("<input type='text' id='area' name='area' style='margin-left

: 10px; padding: 5px; border: 1px solid #800000;'>")
print("<br>")
print("<label for='locality' style='color: #800000; font-weight: bold;'>Locality:</label>")
print("<input type='text' id='locality' name='locality' style='margin-left: 10px; padding: 5px; border: 1px solid #800000;'>")
print("<br>")
print("<label for='unitno' style='color: #800000; font-weight: bold;'>Unit Number:</label>")
print("<input type='text' id='unitno' name='unitno' style='margin-left: 10px; padding: 5px; border: 1px solid #800000;'>")
print("<br>")
print("<label for='Pincode' style='color: #800000; font-weight: bold;'>Pincode:</label>")
print("<input type='text' id='Pincode' name='Pincode' style='margin-left: 10px; padding: 5px; border: 1px solid #800000;'>")
print("<br>")
...
if "action" in form and form["action"].value == "Insert":
    ...
    desiationid = form.getvalue("desiationid")
    qualification = form.getvalue("qualification")
    joiningdate = form.getvalue("joiningdate")
    phoneno = form.getvalue("phoneno")
    dateofleaving = form.getvalue("dateofleaving")
    depid = form.getvalue("depid")
    emailid = form.getvalue("emailid")
    area = form.getvalue("area")
    locality = form.getvalue("locality")
    unitno = form.getvalue("unitno")
    Pincode = form.getvalue("Pincode")
    insert_employee(empid, fname, mname, lname, desiationid, qualification, joiningdate, phoneno, dateofleaving, depid, emailid, area, locality, unitno, Pincode)
