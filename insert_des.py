...
# Add some spacing between navbar and "Designation Details" heading
print("<div style='margin-top: 20px;'></div>")

# Function to insert new Designation details
def insert_desigantion(desid,designation):
    try:
        cursor.execute("INSERT INTO designation (desid,designation)")
        conn.commit()
        print("<p>New designation details inserted successfully.</p>")
    except Exception as e:
        print("<p>Error inserting new designation details: {}</p>".format(str(e)))

# Form to input new Designation details for insertion
print("<div style='text-align: center; padding: 20px;'>")
print("<form method='post' action=''>")
print("<label for='desid' style='color: #800000; font-weight: bold;'>Des ID:</label>")
print("<input type='text' id='desid' name='desid' style='margin-left: 10px; padding: 5px; border: 1px solid #800000;' required>")
print("<br>")
print("<label for='designationname' style='color: #800000; font-weight: bold;'>Designation name:</label>")
print("<input type='text' id='designationname' name='designationname' style='margin-left: 10px; padding: 5px; border: 1px solid #800000;' required>")
print("<br>")
...
if "action" in form and form["action"].value == "Insert":
    desid=form.getvalue("desid")
    designationname= form.getvalue("designationname")
    insert_desigantion(desid,designationname)

# Add the button to check the Designation details
print("<div style='text-align: center; padding: 20px;'>")
